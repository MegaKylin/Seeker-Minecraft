...
2. 
* 以世界默认资源包的方式加载资源包，即将资源包重命名为 `resources.zip` ，选中游玩本数据包的世界，点击 `编辑` -> `打开世界文件夹` ，将重命名的资源包放入打开的文件夹中。
...
2. 
* 对于以世界默认资源包的方式加载资源包，将下载的新资源包重命名为 `resources.zip` ，选中游玩本数据包的世界，点击 `编辑` -> `打开世界文件夹` ，用新资源包替换旧资源包。
