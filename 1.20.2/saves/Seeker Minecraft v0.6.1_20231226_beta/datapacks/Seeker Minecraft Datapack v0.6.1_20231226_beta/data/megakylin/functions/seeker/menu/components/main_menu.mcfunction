...
tellraw @s [{"text": "  ☆  ", "color": "white"}, {"text": "Rules & Tutorials", "color": "green", "hoverEvent": {"action": "show_text", "contents": "Click to Check Rules & Tutorials"}, "clickEvent": {"action": "run_command", "value": "/function megakylin:seeker/menu/open_rules_and_tutorials"}}]
...
tellraw @s {"text": "         Version: Beta 0.6.1", "color": "dark_red"}
