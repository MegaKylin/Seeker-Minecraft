...
tellraw @s [{"text": "\n===============  ", "bold": true, "color": "yellow"}, {"text": "⋘", "bold": true, "color": "aqua", "hoverEvent": {"action": "show_text", "contents": "Previous Page"}, "clickEvent": {"action": "run_command", "value": "/function megakylin:seeker/menu/turn_rules_and_tutorials_page_2"}}, {"text": " Page -- 3/3 ", "bold": false, "color": "gold"}, {"text": "⋙", "bold": true, "color": "gray"}, {"text": "  ===============\n", "bold": true, "color": "yellow"}]
