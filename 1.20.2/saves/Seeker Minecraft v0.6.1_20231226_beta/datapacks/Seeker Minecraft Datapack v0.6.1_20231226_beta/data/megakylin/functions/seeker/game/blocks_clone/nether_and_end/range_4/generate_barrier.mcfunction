...
execute as @s at @s unless block ~ ~ ~ #megakylin:fluid_blocks run fill ~5 ~-4 ~4 ~5 ~-1 ~-4 minecraft:barrier replace minecraft:air
execute as @s at @s unless block ~ ~ ~ #megakylin:fluid_blocks run fill ~-4 ~-4 ~5 ~4 ~-1 ~5 minecraft:barrier replace minecraft:air
execute as @s at @s unless block ~ ~ ~ #megakylin:fluid_blocks run fill ~-5 ~-4 ~-4 ~-5 ~-1 ~4 minecraft:barrier replace minecraft:air
execute as @s at @s unless block ~ ~ ~ #megakylin:fluid_blocks run fill ~-4 ~-4 ~-5 ~4 ~-1 ~-5 minecraft:barrier replace minecraft:air
#> when the player is in fluid
# create protection barrier(sphere shape) to hold fluid
execute as @s at @s if block ~ ~ ~ #megakylin:fluid_blocks run fill ~5 ~-4 ~4 ~5 ~4 ~-4 minecraft:barrier replace minecraft:air
execute as @s at @s if block ~ ~ ~ #megakylin:fluid_blocks run fill ~-4 ~-4 ~5 ~4 ~4 ~5 minecraft:barrier replace minecraft:air
execute as @s at @s if block ~ ~ ~ #megakylin:fluid_blocks run fill ~-5 ~-4 ~-4 ~-5 ~4 ~4 minecraft:barrier replace minecraft:air
execute as @s at @s if block ~ ~ ~ #megakylin:fluid_blocks run fill ~-4 ~-4 ~-5 ~4 ~4 ~-5 minecraft:barrier replace minecraft:air
