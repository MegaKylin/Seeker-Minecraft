...
execute as @s at @s run fill ~-4 ~-196 ~-4 ~4 ~-196 ~4 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~5 ~-196 ~4 ~5 ~-188 ~-4 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~-4 ~-196 ~5 ~4 ~-188 ~5 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~-5 ~-196 ~-4 ~-5 ~-188 ~4 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~-4 ~-196 ~-5 ~4 ~-188 ~-5 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~-4 ~-188 ~-4 ~4 ~-188 ~4 minecraft:barrier replace minecraft:air
