...
execute as @s[type=!#megakylin:flying_mobs,type=!end_crystal,tag=NE] at @s if block ~ 130 ~ minecraft:bedrock unless block ~ ~127 ~ minecraft:air run tp @s[y=0,dy=127] ~ ~128 ~
# flying mobs teleportation
execute as @s[type=#megakylin:flying_mobs,tag=NE] at @s if block ~ 130 ~ minecraft:bedrock run tp @s[y=0,dy=127] ~ ~128 ~
...
execute as @s[type=!end_crystal,tag=NE] at @s unless block ~ 130 ~ minecraft:bedrock run tp @s[y=128,dy=127] ~ ~-128 ~
