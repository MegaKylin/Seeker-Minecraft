...
execute as @s[type=!#megakylin:flying_mobs] at @s if block ~ 130 ~ minecraft:bedrock unless block ~ ~191 ~ minecraft:air run tp @s[y=-64,dy=191] ~ ~192 ~
# flying mobs teleportation
execute as @s[type=#megakylin:flying_mobs] at @s if block ~ 130 ~ minecraft:bedrock run tp @s[y=-64,dy=191] ~ ~192 ~
# modify nbt
...
execute as @s at @s unless block ~ 130 ~ minecraft:bedrock run tp @s[y=128,dy=191] ~ ~-192 ~
