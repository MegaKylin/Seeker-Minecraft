...
execute as @s at @s if block ~ ~ ~ #megakylin:fluid_blocks run fill ~9 ~-8 ~8 ~9 ~8 ~-8 minecraft:barrier replace minecraft:water[level=1]
execute as @s at @s if block ~ ~ ~ #megakylin:fluid_blocks run fill ~-8 ~-8 ~9 ~8 ~8 ~9 minecraft:barrier replace minecraft:water[level=1]
execute as @s at @s if block ~ ~ ~ #megakylin:fluid_blocks run fill ~-9 ~-8 ~-8 ~-9 ~8 ~8 minecraft:barrier replace minecraft:water[level=1]
execute as @s at @s if block ~ ~ ~ #megakylin:fluid_blocks run fill ~-8 ~-8 ~-9 ~8 ~8 ~-9 minecraft:barrier replace minecraft:water[level=1]
...
execute as @s at @s run fill ~-8 ~-200 ~-8 ~8 ~-200 ~8 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~9 ~-200 ~8 ~9 ~-184 ~-8 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~-8 ~-200 ~9 ~8 ~-184 ~9 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~-9 ~-200 ~-8 ~-9 ~-184 ~8 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~-8 ~-200 ~-9 ~8 ~-184 ~-9 minecraft:barrier replace minecraft:air
execute as @s at @s run fill ~-8 ~-184 ~-8 ~8 ~-184 ~8 minecraft:barrier replace minecraft:air
