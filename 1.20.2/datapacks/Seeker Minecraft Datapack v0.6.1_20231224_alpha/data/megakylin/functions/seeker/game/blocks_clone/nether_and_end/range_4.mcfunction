...
execute as @s if score @s current_block_clone_number matches 1.. run function megakylin:seeker/game/blocks_clone/nether_and_end/range_4_generate_protection_barrier
