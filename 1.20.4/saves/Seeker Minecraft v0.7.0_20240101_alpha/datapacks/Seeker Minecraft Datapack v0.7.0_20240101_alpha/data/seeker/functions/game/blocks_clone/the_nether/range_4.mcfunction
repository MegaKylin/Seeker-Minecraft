...
execute as @s at @s run fill ~-4 255 ~-4 ~4 255 ~4 minecraft:bedrock
...
execute as @s if score @s current_block_clone_count matches 1.. run function seeker:game/blocks_clone/the_nether/range_4/clone_operations
