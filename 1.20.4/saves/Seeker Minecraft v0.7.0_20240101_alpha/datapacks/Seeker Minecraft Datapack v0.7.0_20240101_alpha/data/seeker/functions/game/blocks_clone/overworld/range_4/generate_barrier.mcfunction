...
execute as @s at @s if block ~ ~ ~ #seeker:fluid_blocks run fill ~5 ~-4 ~4 ~5 ~4 ~-4 minecraft:barrier replace minecraft:water[level=1]
execute as @s at @s if block ~ ~ ~ #seeker:fluid_blocks run fill ~-4 ~-4 ~5 ~4 ~4 ~5 minecraft:barrier replace minecraft:water[level=1]
execute as @s at @s if block ~ ~ ~ #seeker:fluid_blocks run fill ~-5 ~-4 ~-4 ~-5 ~4 ~4 minecraft:barrier replace minecraft:water[level=1]
execute as @s at @s if block ~ ~ ~ #seeker:fluid_blocks run fill ~-4 ~-4 ~-5 ~4 ~4 ~-5 minecraft:barrier replace minecraft:water[level=1]
