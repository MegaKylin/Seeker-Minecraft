...
execute as @s[type=!#seeker:flying_mobs] at @s unless block ~ ~127 ~ #seeker:placeholder_blocks run tp @s[y=0,dy=127] ~ ~128 ~
...
execute as @s at @s unless block ~ ~-129 ~ #seeker:placeholder_blocks run tp @s[y=128,dy=127] ~ ~-128 ~
