...
execute as @s[type=!#seeker:flying_mobs] at @s unless block ~ ~191 ~ #seeker:placeholder_blocks run tp @s[y=-64,dy=191] ~ ~192 ~
# flying mobs teleportation
execute as @s[type=#seeker:flying_mobs] at @s run tp @s[y=-64,dy=191] ~ ~192 ~
# modify nbt
...
execute as @s at @s unless block ~ ~-193 ~ #seeker:placeholder_blocks run tp @s[y=128,dy=191] ~ ~-192 ~
