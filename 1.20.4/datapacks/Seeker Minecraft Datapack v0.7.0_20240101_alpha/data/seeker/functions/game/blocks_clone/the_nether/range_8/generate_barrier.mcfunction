...
execute as @s at @s if block ~ ~ ~ #seeker:fluid_blocks run fill ~9 ~-8 ~8 ~9 ~8 ~-8 minecraft:barrier replace minecraft:lava[level=1]
execute as @s at @s if block ~ ~ ~ #seeker:fluid_blocks run fill ~-8 ~-8 ~9 ~8 ~8 ~9 minecraft:barrier replace minecraft:lava[level=1]
execute as @s at @s if block ~ ~ ~ #seeker:fluid_blocks run fill ~-9 ~-8 ~-8 ~-9 ~8 ~8 minecraft:barrier replace minecraft:lava[level=1]
execute as @s at @s if block ~ ~ ~ #seeker:fluid_blocks run fill ~-8 ~-8 ~-9 ~8 ~8 ~-9 minecraft:barrier replace minecraft:lava[level=1]
