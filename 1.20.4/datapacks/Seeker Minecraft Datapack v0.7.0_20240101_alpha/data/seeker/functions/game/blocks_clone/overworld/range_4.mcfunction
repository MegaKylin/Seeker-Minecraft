...
#> move blocks
execute as @s at @s store result score @s current_block_clone_count run clone ~-4 ~-196 ~-4 ~4 ~-188 ~4 ~-4 ~-4 ~-4 filtered #seeker:non_placeholder_blocks move
execute as @s if score @s current_block_clone_count matches 1.. run function seeker:game/blocks_clone/overworld/range_4/clone_operations
